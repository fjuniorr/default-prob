library(magrittr)
source("code/R/lib/parsers.R"); source("code/R/lib/parsers_contratos.R")
# ==========================================================
...
# ==========================================================
manual <- readxl::read_excel("data/manual/contratos.xlsx")
...
# save
# ==========================================================
write.csv(DF, "data/munged/contratos.csv", row.names = FALSE)
