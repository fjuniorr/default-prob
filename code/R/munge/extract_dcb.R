library(magrittr)
source("code/R/lib/parsers.R"); source("code/R/lib/parsers_dcb.R")
# ==========================================================
...
# ==========================================================
manual <- readxl::read_excel("data/manual/dcb.xlsx")
...
# save
# ==========================================================
write.csv(DF, "data/munged/dcb.csv", row.names = FALSE)
