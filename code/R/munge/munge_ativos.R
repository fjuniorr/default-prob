library(magrittr)
source("code/R/lib/parsers.R"); source("code/R/lib/parsers_ativos.R")
# ==========================================================
...
# ==========================================================
manual <- readxl::read_excel("data/manual/ativos.xlsx")
...
# save
# ==========================================================
write.csv(DF, "data/munged/ativos.csv", row.names = FALSE)
